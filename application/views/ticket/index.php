                    ...
                    <div class="box box-primary">
                        ...
                        <div class="box-body">
                            <div class="form-group">
                                ...
                                <?= form_error('namaWilayah', '<small class="text-danger pl-3">', '</small>'); ?>
                            </div>
                            <div class="form-group">
                                <label>Nama Satker</label>
                                <select class="form-control select2" id="namaSatker" name="namaSatker" style="width:100%" disabled>
                                </select>
                                <?= form_error('namaSatker', '<small class="text-danger pl-3">', '</small>'); ?>
                            </div>
                        </div>
                        <div class="box-footer">
